...
1.  **Understanding Traces**
    ...
    -   [[Jupyter Notebook]](./03_understanding_traces.ipynb)

2.  **Crafting Custom Reward Functions**
    -   Explore built-in reward functions and learn how to create your own.
    -   [[Jupyter Notebook]](./04_crafting_custom_reward_functions.ipynb)
...
3.  **DPO vs. GRPO vs. Supervised - Choosing Your Algorithm**
    ...
    -   [[Jupyter Notebook]](./05_dpo_vs_grpo_vs_supervised.ipynb)
...
5.  **Automatic Task Generation (Zero-Learn)**
    ...
    -   [[Jupyter Notebook]](./10_zero_learn_for_automatic_task_generation.ipynb)
...
-   **Extending and Contributing to ToolBrain**
    ...
    -   [[Jupyter Notebook]](./part_05_development_and_contribution.ipynb)
